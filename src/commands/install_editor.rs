...
//!   single extension carries the LSP client; query-DSL syntax colouring
//!   is delivered server-side via `textDocument/semanticTokens` instead
//!   of a TextMate grammar, so one `.vsix` covers everything.
